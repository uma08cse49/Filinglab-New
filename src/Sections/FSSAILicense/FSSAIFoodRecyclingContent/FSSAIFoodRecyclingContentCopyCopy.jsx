...
<div style={styles.container}>
    ...
    {/* <div style={{
        ...
        <h1 id = "overview" style={styles.mainHeading}>Overview of Food Recycling License</h1>
        ...
        <h1 id = "listicles" style={styles.mainHeading}>Documents Required for Food Recycling License</h1>

            <p>The list of Documents required for the Food Recycling Business is:</p>
        ...
        <h1 id="registration" style={styles.mainHeading}>Procedure for the Food Recycling License</h1>
            <p style={styles.paragraph}>
        ...
        <h1 id="filinglabsupport" style={styles.mainHeading}>FilingLab Assistance for obtaining Food Recycling License</h1>
