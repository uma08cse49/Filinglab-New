...
const FSSAILicenseFeatures = () => {
  const features = [
    "Mandatory for food-related businesses, the FSSAI food license ensures compliance with food safety regulations.",
    "FSSAI certification validates the compliance of food products with safety and hygiene standards set by the FSSAI.",
    "It helps boost consumer confidence by validating adherence to food safety guidelines.",
    "It enhances the credibility of food businesses, helping them attract investors and partners.",
    "It facilitates maintaining uniform food safety standards across all the states in India.",
    "It requires businesses to label their food products correctly, including ingredients, nutritional information, and expiry dates.",
    "It mandates food safety audits at regular intervals to comply with FSSAI guidelines."
  ];
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-7 mx-auto">
                    <Title>Features of FSSAI License</Title>
                    <Description>
                        FSSAI license ensures food businesses comply with safety standards,
                        promoting public health and consumer trust.
                    </Description>
                </div>    
            </div> 
        </div>                    
