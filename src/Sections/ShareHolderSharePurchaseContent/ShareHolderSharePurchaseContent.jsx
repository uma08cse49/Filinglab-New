...
`;
const ShareHolderSharePurchaseContent = () => {
  ...
  {/* Share Purchase Agreement Panel */}
  <div style={{
    flex: 1,
    ...
    <h2 style={{
      fontSize: '26px',
      marginBottom: '20px',
      borderBottom: '1px solid #ed740a',
      paddingBottom: '8px'
    }}>
      Overview of <span style={{ color: '#ed740a' }}>Share Purchase Agreement</span>
    </h2>
    <p style={{ fontSize: '16px', lineHeight: '1.6', marginBottom: '16px' }}>
      A Share Purchase Agreement outlines the terms and conditions of the sale and purchase of shares in a company, ensuring clarity and mutual consent between the buyer and seller.
    </p>
    <ul style={{ paddingLeft: '20px', margin: 0 }}>
      <li style={{ marginBottom: '10px' }}>Defines how ownership of shares is transferred from seller to buyer.</li>
      <li style={{ marginBottom: '10px' }}>Specifies number of shares, sale price, and other relevant terms.</li>
      <li style={{ marginBottom: '10px' }}>Establishes that both parties have agreed to the transaction voluntarily.</li>
      <li style={{ marginBottom: '10px' }}>Triggers the formal process of share allotment post-signing.</li>
    </ul>
  </div>

  {/* Shareholder's Agreement Panel */}
  <div style={{
    flex: 1,
    backgroundColor: '#ffffff',
    ...
    <h2 style={{
      fontSize: '26px',
      marginBottom: '20px',
      borderBottom: '1px solid #002145',
      paddingBottom: '8px'
    }}>
      Overview of <span style={{ color: '#002145' }}>Shareholder's Agreement</span>
    </h2>
    <p style={{ fontSize: '16px', lineHeight: '1.6', marginBottom: '16px' }}>
      A Shareholder's Agreement acts as a governing contract between the shareholders of a business, defining their relationship and rights within the company.
    </p>
    <ul style={{ paddingLeft: '20px', margin: 0 }}>
      <li style={{ marginBottom: '10px' }}>Outlines roles, responsibilities, and rights of shareholders.</li>
      <li style={{ marginBottom: '10px' }}>Regulates share transfers and decision-making procedures.</li>
      <li style={{ marginBottom: '10px' }}>Ensures critical company matters require shareholder consensus.</li>
      <li style={{ marginBottom: '10px' }}>Maintains corporate transparency and reduces internal conflicts.</li>
    </ul>
  </div>
...
export default ShareHolderSharePurchaseContent;