...
const FPOCertificationBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        FPO Certification in India 
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        "Are you a manufacturer or seller of processed fruit products? Obtain your FPO Certification effortlessly and ensure your products meet the standards for safe consumption!"
        </p>
...
export default FPOCertificationBanner;