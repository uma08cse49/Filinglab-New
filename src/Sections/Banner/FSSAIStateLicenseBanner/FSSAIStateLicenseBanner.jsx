...
const FSSAIStateLicenseBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        Confused about the legal requirements for obtaining an FSSAI State License? Let our experts simplify the process and help you secure your license smoothly—minimizing compliance hassles for your food business.
        </p>
...
export default FSSAIStateLicenseBanner;