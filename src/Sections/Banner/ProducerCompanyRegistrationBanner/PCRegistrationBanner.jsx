...
const PCRegistrationBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        <p>Looking to improve your agricultural income or expand your farming activities? Registering a Producer Company offers numerous benefits. Our experts simplify the entire registration process, ensuring smooth compliance and long-term growth for your agri-business.</p>
...
export default PCRegistrationBanner;