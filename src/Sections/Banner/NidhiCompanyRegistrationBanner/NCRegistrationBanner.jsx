...
const NCRegistrationBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        "Starting a Nidhi Company doesn’t have to be complicated. Our expert team handles the entire registration process, empowering you to focus on building financial security for your members."
        </p>
...
export default NCRegistrationBanner;