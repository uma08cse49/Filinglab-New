...
const OPCRegistrationBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        <p>Facing challenges in making the desired choice for solopreneurs? Get expert assistance for easy-breezy One Person Company Registration.</p>
...
export default OPCRegistrationBanner;