...
const HazardousWasteImportExportBanner = () => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        Hazardous Waste<span style={{color:'#002145'}}>Import</span>Export
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        Hazardous-Waste-Import-Export </p>
...
export default HazardousWasteImportExportBanner;
