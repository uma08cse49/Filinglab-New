...
const FSSAICentralLicenseBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        Apply easily with Filinglab and streamline your food safety compliance. Ensure your food business operates legally and confidently with expert assistance.
        </p>
...
export default FSSAICentralLicenseBanner;