...
const CompanyRegistrationBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        "Get expert guidance from our seasoned consultants for seamless company registration in India. Join over 50,000 entrepreneurs across the country who have successfully registered their private limited companies with us."
        </p>

        <p style={{ fontSize: "1.5rem", marginBottom: "20px", color: "#ed740a" }}>
        What's Included?
        </p>
