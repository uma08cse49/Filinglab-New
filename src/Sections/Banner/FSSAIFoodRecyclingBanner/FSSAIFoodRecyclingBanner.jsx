...
const FSSAIFoodRecyclingBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        FSSAI Food Recycling License 
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        "Are you an aspiring entrepreneur looking to launch a food recycling business in India? Let Filinglab help you secure your food recycling license with expert guidance."
        </p>
...
export default FSSAIFoodRecyclingBanner;