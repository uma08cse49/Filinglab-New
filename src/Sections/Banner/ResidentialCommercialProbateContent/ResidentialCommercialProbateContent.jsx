...
const ResidentialCommercialProbateContent = () => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        Residentiall -<span style={{color:'#002145'}}>Commercia</span> - Probate
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        Residential Commercial Probate        </p>
...
export default ResidentialCommercialProbateContent;
