...
const ShareHolderSharePurchaseBanner = () => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        ShareHolder<span style={{color:'#002145'}}>SharePurchase</span>
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        service-joint-franchies        </p>
...
export default ShareHolderSharePurchaseBanner;
