...
const FSSAIAnnualReturnBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        "Are you a food business operator looking to stay compliant with FSSAI regulations and maintain a spotless legal record?
        Let our experts at FilingLab simplify your FSSAI Annual Return filing—quick, accurate, and hassle-free.</p>

        <p>✅ Trusted by 3,000+ foodpreneurs across India</p> 
        <p>✅ 20% faster processing with zero hidden charges</p>
...
export default FSSAIAnnualReturnBanner;