    ...
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
          Get your GST Number in a simple and hassle-free way. Start your GST Registration in {city} with Filing Lab today and ensure smooth compliance for your business.
        </p>
        <ul style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black", marginTop: "15px" }}>
          <li>✔️ Fast Online Process</li>
...
export default GSTBannerWithForm;
