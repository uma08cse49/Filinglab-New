...
const LLPRegistrationBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        "Facing a delay in the process of online LLP registration in India? Our consultants ensure hassle-free limited liability partnership registration within a short time and give wings to business dreams"
        </p>
...
export default LLPRegistrationBanner;