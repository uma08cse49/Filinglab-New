...
const OtherWasteManagementTypesBanner = () => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        <h1 style={{ fontSize: "2.5rem", marginBottom: "20px", color: " #ed740a" }}>Other-Waste-Management-Types
        Other Waste<span style={{color:'#002145'}}>Management</span>Types
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        Other Waste Management Types </p>
...
export default OtherWasteManagementTypesBanner;
