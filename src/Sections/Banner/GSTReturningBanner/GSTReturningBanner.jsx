  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        GST Return <span style={{color:'#002145'}}>Filing</span>
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        Get your GST Return filing done with FilingLab. Our experts will provide assistance throughout the process.
        </p>
...
export default GSTReturningBanner;
