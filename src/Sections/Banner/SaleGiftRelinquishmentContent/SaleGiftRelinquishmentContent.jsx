...
const SaleGiftRelinquishmentContent = () => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        Sale -<span style={{color:'#002145'}}>Gift</span> - Relinquishment
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        Sale Gift RelinquishmentContent      </p>
...
export default SaleGiftRelinquishmentContent;
