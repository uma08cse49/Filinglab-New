...
const FSSAILicenseRenewalBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        Renew your FSSAI license effortlessly with FilingLab. Our experts handle the entire process, ensuring full compliance and a smooth, hassle-free experience to keep your food business running without interruptions.
        </p>
...
export default FSSAILicenseRenewalBanner;