...
const SoleProprietorshipBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        <p>Facing delays in registering your sole proprietorship? Our expert team offers complete end-to-end support to ensure a smooth and faster registration process.we guarantee a hassle-free experience.</p>
...
export default SoleProprietorshipBanner;