...
const PartnerShipFirmRegistrationBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        <p>Are you looking to register a partnership firm in India but not sure how to begin? You’re in the right place. We make partnership firm registration simple and hassle-free, so you can focus on growing your business while we handle the paperwork and procedures. Most of the partnership firms registered through us are now successfully expanding and scaling their operations.</p>
...
export default PartnerShipFirmRegistrationBanner;