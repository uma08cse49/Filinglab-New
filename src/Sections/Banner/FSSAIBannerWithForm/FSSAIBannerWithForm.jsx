...
const FSSAIBannerWithForm = ({ city }) => {
    ...
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        <h1 style={{ fontSize: "2.5rem", marginBottom: "20px", color: "#ed740a" }}>
          FSSAI Registration in {city}
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        Looking to start a Food Business in {city}? Then it is vital to have an FSSAI Registration at the earliest. Contact us to get this without any hassle.
        </p>
...
export default FSSAIBannerWithForm;