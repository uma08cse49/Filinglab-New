...
const FSSAIProductApprovalBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        FSSAI Product Approval Process
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        If you want to apply for a Product Approval of ingredients, you can contact us to avail of FSSAI Product Approval Process service from our professional experts.
        </p>
...
export default FSSAIProductApprovalBanner;