...
const FSSAIEatingHouseLicenseBanner = ({ city }) => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        An Eating House License is a mandatory requirement in addition to the FSSAI License for operating a food business at a particular location. The validity of this license varies from state to state; however, it typically ranges from one to three years depending on the local authority.
        </p>
...
export default FSSAIEatingHouseLicenseBanner;