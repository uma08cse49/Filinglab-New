...
const HazardousWasteManagementAuthorizationBanner = () => {
  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        Hazardous Waste<span style={{color:'#002145'}}>Management</span>& Authorization
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        Hazardous Waste Management & Authorization </p>
...
export default HazardousWasteManagementAuthorizationBanner;
