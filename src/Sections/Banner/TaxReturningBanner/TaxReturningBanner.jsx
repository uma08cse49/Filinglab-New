  ...
  return (
    <Section className={isSticky ? "sticky" : ""}>
      <Left>
        ...
        Income Tax  <span style={{color:'#002145'}}>Returning</span>
        </h1>
        <p style={{ fontSize: "1.1rem", lineHeight: "1.6", color: "black" }}>
        Are you worried about missing the ITR deadline? Connect Filing Lab to get personalized support for seamless income tax return filing in India and join the league of 10 million+ taxpayers who trust us.        </p>
