...
const TrustFilingLab = () => {
  const trustPoints = [
    {
      ...
      desc: "We at Filing Lab have processed 5000+ GST registration applications with an easy and seamless approach.",
    },
    {
  ...
  return (
    <Section>
      <Container>
        <Title>Why Trust Filing Lab for GST Registration?</Title>
        <Grid>
