...
const SoleProprietorshipRegistrationBenefit = () => {
  return (
    <Section>
      <Container>
        <LeftContent>
          <h2>Advantages of Sole Proprietorship Firm Registration Online</h2>
          <p>
...
export default SoleProprietorshipRegistrationBenefit;
