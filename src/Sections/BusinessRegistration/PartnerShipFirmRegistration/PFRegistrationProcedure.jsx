  ...
  return (
    <section style={sectionStyle}>
      <div style={containerStyle}>
        <h2 style={headingStyle}>How to Register a Partnership Firm Online in India?</h2>
        ...
        <div style={gridStyle}>
          ...
          <div style={stepsContainerStyle}>
            <div style={{ display: "flex", gap: "15px" }}>
              ...
              <div>
                <div style={stepTitleStyle}>Determine a Business Activity</div>
            ...
            <div style={stepStyle}>
              ...
              <div>
                <div style={stepTitleStyle}>Gather Documents</div>
                <div style={stepTextStyle}>
                  Documents, such as Identity, address, and PAN IDs, are required for partnership firm registration online. Our associates will notarize all documents if required by law.
                </div>
              </div>
            </div>
            ...
            <div style={stepStyle}>
              ...
              <div>
                <div style={stepTitleStyle}>Select a Name</div>
                <div style={stepTextStyle}>
                Even though it is not mandatory to reserve a business name, you must choose a firm name. Our lawyers will assist you in finalizing a name that is 100% compliant with the Indian Partnership Act of 1932.
                </div>
              </div>
            </div>
            ...
            <div style={stepStyle}>
              ...
              <div>
                <div style={stepTitleStyle}>Draft a Partnership Deed</div>
                <div style={stepTextStyle}>
                Our experts will work closely with you to understand your requirements and prepare a customized partnership deed. Submitting a well-drafted deed is a mandatory step and lays the legal foundation for starting your partnership firm.
                </div>
              </div>
            </div>
            ...
            <div style={stepStyle}>
              ...
              <div>
                <div style={stepTitleStyle}>Apply with the Registrar of Partnership Firms</div>
                <div style={stepTextStyle}>
                We’ll fill out Form 1 with the necessary documents, along with the deed and registered business address to the respective registrar of the state.
                </div>
              </div>
            </div>
            ...
            <div style={stepStyle}>
              ...
              <div>
                <div style={stepTitleStyle}>Receive the Certificate</div>
                <div style={stepTextStyle}>
                The registrar of a partnership firm will examine the application, documents, and deed agreement. After approval, they’ll send the certificate and sealed partnership deed to your registered office address.
                </div>
              </div>
            </div>
              ...
              <div>
                <div style={stepTitleStyle}>Register for PAN and GST</div>
                <div style={stepTextStyle}>
                Our seasoned consultants will apply for a permanent account number (PAN) and goods and services tax PIN, if applicable, on your behalf.
                </div>
              </div>
            </div>
             ...
             <div style={stepStyle}>
              ...
              <div>
                <div style={stepTitleStyle}>Open a Bank Account</div>
                <div style={stepTextStyle}>
                After you’re registered for taxes, we’ll help you make a business plan and application filing to open your firm’s bank account after partnership firm registration.
                </div>
              </div>
            </div>
...
export default PFRegistrationProcedure;
