                    ...
                    <ul className="navbar-nav main-menu">
                      {Data?.map((menuItem, i) => (
                        <li
                          key={i}
                          className={`nav-item ${menuItem.hasMegaMenu ? "home-nav" : ""}`}
                          onMouseEnter={() => menuItem.hasMegaMenu && openMenu(i)}
                          onMouseLeave={() => menuItem.hasMegaMenu && closeMenu()}
                        >
                          <NavLink
                            className={`${
                              menuItem.hasMegaMenu ? "nav-link megaTablinks" : "nav-link"
                            } ${menuItem.subMenus?.length > 0 ? "has-submenu" : ""}`}
                            to={menuItem.url}
                          >
                            {menuItem.title}
